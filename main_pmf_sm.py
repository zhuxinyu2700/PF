...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./results/PMF/cm', help="output path")
...
def main(args):
    ...
    validation_set = KBDataset(args.validation_ratings, args.prefetch_to_gpu)
    ...
    if not args.dont_train:
        ...
        for epoch in tqdm(range(1, args.num_epochs + 1)):
            '''if epoch % args.valid_freq == 0 or epoch == 1:
                ...
                print("epoch %d : test PMF Loss is %f " % (epoch, validation_loss))
                print("epoch %d : test H@5 is %f " % (epoch, validaton_hit))
